...
namespace SAS.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _securityLogic.AddUsersToRole(Input.RoleID, Input.Email).Wait();

                    ViewData["roles"] = _securityLogic.GetAllRoles();
                    returnUrl = "/Security/ManageUsers";
